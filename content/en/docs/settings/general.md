...
The general settings live in `data/<lang>/general.yaml`.
...
The `contactbuttons` shortcode reads them, strips the phone number to digits for its `tel:` link and gives each button a real accessible name.
