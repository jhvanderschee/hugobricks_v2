...
![](/uploads/photos/bricks.jpg){:.background}

---

This is a placeholder page to test the main menu. This page is the parent of a few subpages (in the menu). Breadcrumbs are based on this menu structure. Note that this only works for two levels. If you need more levels you should use the 'Docs' feature.
