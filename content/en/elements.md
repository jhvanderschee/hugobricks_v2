...
[Get started for free](/get-started/){:.button.secondary}
...
| Brick | Container | Where it appears |
|-------|-----------|------------------|
| intro | small | the home page |
| image | twocols | the demo pages |
| cta | boxed twocols | almost every page |
...
{{< video src="/uploads/video/flowers.mp4" poster="" >}}
...
<figure>
    <audio controls preload="metadata">
        <source src="/uploads/audio/jamming.mp3" type="audio/mpeg">
        <p>Your browser does not support HTML5 audio. Here is <a href="/uploads/audio/jamming.mp3">a link to download the track</a>.</p>
    </audio>
</figure>
